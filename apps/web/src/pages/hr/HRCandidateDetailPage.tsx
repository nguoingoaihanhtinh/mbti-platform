// // src/pages/hr/HRCandidateDetailPage.tsx
...
//   const { assessmentId } = useParams({ from: "/hr/candidates/$assessmentId" });
...
//       try {
//         const resultRes = await api.get(`/hr/candidates/${assessmentId}/result`);
...
//           <button
//             onClick={() => navigate({ to: "/hr/candidates" })}
